...
//stor the values into variables
$secret = "6LcPmgQTAAAAAD2XQXfomdwCcyxkQ-x7mJLoGQqz";
$respose = $_POST['g-recaptcha-response'];

//initalize the curl library to do a hidden post to google
$ch = curl_init();
...
//convert the response object from json to a php result
