<?php ob_start();  //set the page title and embed header
...
<?php
//add error handler in case anything breaks
try {
//connect
    require_once('db.php');
...
//disconnect
    ...
    mail('missybauer18@gmail.com', 'Games Listin Error', $e);
